...
import { MapPin, Bell, Search, Plus, User, Filter, Heart, MessageCircle, Share2, AlertTriangle, Calendar, Zap, Eye, Settings, Menu, X, Send } from 'lucide-react';
...
const MetroPulse = () => {
  ...
  const EventCard = ({ event } : {event : any}) => (
    <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4 hover:shadow-lg transition-all duration-200 cursor-pointer transform hover:-translate-y-1"
         onClick={() => setSelectedEvent(event)}>
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center space-x-2">
          <div className={`w-3 h-3 rounded-full shadow-sm ${
            event.priority === 'urgent' ? 'bg-gradient-to-r from-red-500 to-red-600' : 
            event.priority === 'high' ? 'bg-gradient-to-r from-orange-500 to-amber-500' : 'bg-gradient-to-r from-blue-500 to-blue-600'
          }`}></div>
          <span className="text-sm font-medium text-gray-900">{event.title}</span>
        </div>
        <span className="text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded-full">{event.time}</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          {event.tags.map((tag: undefined) => (
            <span key={tag} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 text-xs px-2 py-1 rounded-full border border-blue-200">
              {tag}
            </span>
          ))}
        </div>
    ...
    <div className="h-full bg-gray-100 rounded-lg relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Interactive City Map</h3>
          <p className="text-sm text-gray-600">Real-time events and alerts visualization</p>
        </div>
      </div>
  ...
  const Sidebar = () => (
    <div className={`fixed inset-y-0 left-0 w-64 bg-gray-900 border-r border-gray-700 transform transition-transform duration-300 ease-in-out z-50 ${
      ...
      <nav className="p-4">
        <div className="space-y-2">
          <button 
            ...
            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
              activeTab === 'feed' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
              activeTab === 'map' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
        ...
        <div className="mt-8 pt-4 border-t border-gray-700">
          <h3 className="text-sm font-medium text-gray-200 mb-3">Personalization</h3>
          <div className="space-y-2">
            <button className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left text-gray-300 hover:bg-gray-800">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-300">Bengaluru, Karnataka</span>
              </div>
            </div>
          ...
          {activeTab === 'feed' ? (
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-bold text-white">Live City Feed</h1>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-lg mb-6 shadow-lg">
                ...
                <p className="text-sm opacity-90">
                  High activity detected in Brigade Road area. Power outages reported in Koramangala. 
                  3 community events happening near you based on your ENFP profile.
                </p>
              </div>
              
              {/* Events in Your Area */}
              <div className="mb-8">
                <h2 className="text-lg font-semibold text-white mb-4">Events in Koramangala</h2>
                <div className="relative">
                  <div className="flex space-x-4 overflow-x-auto scroll pb-4">
                    ...
                    <div className="min-w-[280px] bg-gradient-to-br from-pink-50 to-rose-100 border border-pink-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-1">Jazz Night at Toit</h3>
                      <p className="text-sm text-gray-600 mb-2">Live music and craft beer</p>
                    ...
                    <div className="min-w-[280px] bg-gradient-to-br from-emerald-50 to-teal-100 border border-emerald-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-1">Yoga in the Park</h3>
                      <p className="text-sm text-gray-600 mb-2">Morning session at Lalbagh</p>
                      <div className="flex items-center text-xs text-gray-500">
                        <MapPin className="w-3 h-3 mr-1" />
                    ...
                    <div className="min-w-[280px] bg-gradient-to-br from-amber-50 to-orange-100 border border-amber-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-1">Food Truck Festival</h3>
                      <p className="text-sm text-gray-600 mb-2">Local cuisines and street food</p>
                      <div className="flex items-center text-xs text-gray-500">
                        <MapPin className="w-3 h-3 mr-1" />
                    ...
                    <div className="min-w-[280px] bg-gradient-to-br from-indigo-50 to-purple-100 border border-indigo-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-1">Tech Meetup</h3>
                      <p className="text-sm text-gray-600 mb-2">AI & Machine Learning talk</p>
                      <div className="flex items-center text-xs text-gray-500">
                        <MapPin className="w-3 h-3 mr-1" />
              ...
              {/* Real-time Updates */}
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-white mb-4">Real-time Updates</h2>
              </div>
          ...
          <div className="bg-white rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="flex items-center space-x-2 mb-4">
                <MapPin className="w-4 h-4 text-gray-400" />
                <span className="text-sm text-gray-500">{selectedEvent.location}</span>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                <span className="text-xs text-gray-500">MBTI Match: {selectedEvent.mbtiMatch}</span>
              </div>
            </div>
          </div>
        </div>
